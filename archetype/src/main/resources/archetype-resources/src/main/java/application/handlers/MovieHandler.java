...
import ${package}.application.transformer.ResponseEntityTransformer;
import ${package}.application.transport.request.entities.MovieRequestEntity;
import ${package}.application.transport.response.transformers.MovieTransformer;
import ${package}.application.transport.response.transformers.ResourceIdentifierTransformer;
import ${package}.application.validator.RequestEntityValidator;
import ${package}.domain.entities.Movie;
import ${package}.domain.services.MovieService;
